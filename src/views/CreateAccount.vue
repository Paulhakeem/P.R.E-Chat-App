...
<template>
  ...
  <div class="relative py-16">
    <div class="relative container m-auto px-6 text-[#000] md:px-12 xl:px-40">
      <div class="m-auto md:w-8/12 lg:w-6/12 xl:w-6/12">
        <div class="rounded-xl bg-primary shadow-xl">
          <div class="p-6 sm:p-16">
            <div class="space-y-4">
              ...
              />
              <h2
                class="mb-8 text-2xl text-cyan-900 font-bold first-letter:uppercase"
              >
                create your account <br />
                and enjoy chating with our chat app.
              </h2>
            </div>
